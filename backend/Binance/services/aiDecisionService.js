...
const prompt = `
                ...
                Analyze the SOLUSDT market data and return ONLY valid JSON.
                ...
                * Base analysis only on provided data
                ...
                MARKET DATA: ${JSON.stringify(context)} `;
...
const groq = new Groq({ apiKey: process.env.GROQ_API_KEY });
    ...
    await AIStrategyLog.create({
      ...
      entryPrice:    parsed.recommendedEntry,
      currentPrice:  context?.candles?.slice(-1)[0]?.close,
      stopLoss:      parsed.recommendedStopLoss,

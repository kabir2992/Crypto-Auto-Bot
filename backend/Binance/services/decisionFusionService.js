const decisionFusionService =  ({ aiDecision, strategyDecision, strategyVotes }) => {
    ...
    if (totalVotes > 0 && strategyDecision === "BUY" || strategyDecision === "LONG_BUY" || strategyDecision === "SHORT_SELL")
    {
        strategyConfidence = (strategyVotes.BUY / totalVotes) * 100;
    }

    if (totalVotes > 0 && strategyDecision === "SELL" || strategyDecision === "LONG_SELL" || strategyDecision === "SHORT_CLOSING")
    {
